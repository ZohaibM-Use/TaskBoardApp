...
A RESTful task management API built with Spring Boot. Campus Taskboard allows users to create, read, update, and delete tasks — each with a title, description, priority level, and completion status.
